...
const AddNewProperty = () => {
  ...
  const uploadImg = (filePath, file) => {
    return new Promise((resolve, reject) => {
      ...
      const fullPath = `${filePath}/${file.name}--${crypto
        .randomUUID()
        .slice(0, 5)}`
  ...
  const handleAmenitiesChange = (e) => {
    ...
    if (checked) {
      ...
      index !== -1 && updatedAmenities.splice(index, 1)
    }
  ...
  return (
    <form className='form register-form' onSubmit={handleSubmit}>
      ...
      <div className='reg-form-switch-div'>
        ...
        <div>
          <button
            ...
            value='sale'
            className={`${
              listType === 'sale' && 'formButtonActive '
            } reg-form-button`}
          >
            sale
          </button>
          <button
            ...
            value='rent'
            className={`${
              listType === 'rent' && 'formButtonActive '
            } reg-form-button`}
          >
            rent
          </button>
      ...
      <div className='form-btn-container'>
        {showAlert && (
          <div className='small-form-alert'>Please fill in all fields</div>
        )}
